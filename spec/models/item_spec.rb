...
RSpec.describe Item, type: :model do
  ...
  describe '#prorated_amount' do
    it "should return the amortized value" do
      item = FactoryBot.build(:item, unit_amount: 7, quantity: 1, period_unit: :day, period_count: 3)
      ...
      item = FactoryBot.build(:item, unit_amount: 14, quantity: 1, period_unit: :week, period_count: 1)
      ...
      item = FactoryBot.build(:item, unit_amount: 5, quantity: 2, period_unit: :month, period_count: 2)
    ...
    it "should optionally include sales tax" do
      item = FactoryBot.build(:item, unit_amount: 5, quantity: 2, period_unit: :month, period_count: 2, sales_tax: true)
